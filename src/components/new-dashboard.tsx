...
<div className="header">
  ...
  <div className="header-center">
    <h2>গাজীপুর পল্লী বিদ্যুৎ সমিতি-২</h2>
    <p>Gazipur Palli Bidyut Samity-2</p>
  </div>
