...
export default function ApplicationFormPage() {
  ...
  const [generatedApp, setGeneratedApp] = useState<React.ReactNode | null>(
    null
  );
...
`;
    ...
    setGeneratedApp(
      <div id="application-preview" className="bg-white p-8 rounded-lg shadow-lg aspect-[1/1.414] min-h-[500px] overflow-auto text-black font-body print:shadow-none print:border-none">
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2 space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Install">বকেয়া বিদ্যুৎ বিল কিস্তিতে পরিশোধের অনুমতি</SelectItem>
             ...
             <div className="space-y-2 relative">
                ...
                <Input id="accNo" name="accNo" value={appData.accNo} onChange={handleInputChange} placeholder="Search by Account No..." />
            ...
            <div className="md:col-span-2 space-y-2">
                ...
                <Textarea id="extraDesc" name="extraDesc" value={appData.extraDesc} onChange={(e) => handleInputChange(e)} rows={2}/>
            </div>
          </div>
      ...
      {generatedApp && (
         <Card ref={previewRef}>
          ...
          <CardContent className="flex flex-col items-center">
            ...
            <Button onClick={handlePrint} className="mt-4 print-hidden">সরাসরি প্রিন্ট করুন</Button>
          </CardContent>
        </Card>
      )}
    </div>
